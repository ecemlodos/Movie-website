...
public partial class ActorInfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand command2 = new SqlCommand("SELECT CONVERT(VARCHAR,YEAR(RELEASE_DATE)) as RELEASE_DATE,M.FILMID, M.TITLE, CC.CHARACTER_, M.POSTER_PATH FROM CAST_CREDIT CC INNER JOIN PERSON P ON P.PERSONID = CC.PERSONID INNER JOIN MOVIE M ON M.FILMID = CC.FILMID WHERE P.DEPARTMENTID = 13 AND P.PERSONID = @p2 ORDER BY RELEASE_DATE DESC", con.baglanti());
