<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AddContent.aspx.cs" Inherits="AddContent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="col-10">
        ...
        <div class="card-header">
            <h3 class="card-title">Movie of the Day</h3>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer">
            ...
            <asp:Button ID="SaveButton" runat="server" Text="Save" OnClick="SaveButton_Click" class="btn btn-default float-right"/>
        </div>
    </div>
    </div>
</asp:Content>
