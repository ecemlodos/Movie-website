<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ActorInfo.aspx.cs" Inherits="ActorInfo" %>
                    ...
                    <tr>
                        <td>
                            <table class="auto-style9">
                               ...
                               <tr>
                                   <td>
                                        <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="CHARACTER: " Font-Names="Helvetica"></asp:Label>
                                        <asp:Label ID="Label6" runat="server" Text='<%# Eval("CHARACTER_") %>'  Font-Names="Helvetica"></asp:Label>
                                   </td>
                               </tr>
                               <tr>
                                   <td>
